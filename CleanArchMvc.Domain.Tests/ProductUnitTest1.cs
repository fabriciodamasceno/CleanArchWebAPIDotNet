...
namespace CleanArchMvc.Domain.Tests
{
    public class ProductUnitTest1
    {
        ...
        public void CreateProduct_ShortNameValue_DomainExceptionShortName()
        {
            ...
            action.Should()
                .Throw<CleanArchMvc.Domain.Validation.DomainExceptionValidation>()
                   .WithMessage("Nome inválido. O tamanho minímo é de 3 caracteres.");
        }
        ...
        public void CreateProduct_LongImageName_DomainExceptionLongImageName()
        {
            ...
            action.Should()
                .Throw<CleanArchMvc.Domain.Validation.DomainExceptionValidation>()
                 .WithMessage("O tamanho máximo da imagem deve ser de 250 caracteres.");
        }
        ...
        public void CreateProduct_InvalidStockValue_ExceptionDomainNegativeValue(int value)
        {
            Action action = () => new Product(1, "Pro", "Product Description", 9.99m, value,
                "product image");
            action.Should().Throw<CleanArchMvc.Domain.Validation.DomainExceptionValidation>()
                   .WithMessage("O estoque não pode ser menor que zero.");
        }
    }
}
